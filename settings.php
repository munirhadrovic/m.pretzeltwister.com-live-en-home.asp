<?php
	$adresa="3705 Mason Road, New Hill, North Carolina 27562"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=9193878929;// Broj koji se poziva na dugme CALL US
